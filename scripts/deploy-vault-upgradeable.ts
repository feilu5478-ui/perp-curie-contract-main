...
async function main() {
  ...
  // 配置参数
  const INSURANCE_FUND = "0xb7f1d4461216b87Db5C6990c876883D7854bfE5E";
  const CLEARING_HOUSE_CONFIG = "0x2D0F2F30E47918be3D99dF88983251DA221063DE";
  const ACCOUNT_BALANCE = "0x93EC9F5e8037c4fA5e2490A6e774B1e97Bd4CFA2";
  const EXCHANGE = "0x00c8f23c3e497FD3Ed5af36471cc29dD96028883";
