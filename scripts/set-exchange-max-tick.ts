...
async function main() {
  ...
  const BASE_TOKEN = "0x9efd6d5c81c6e22b822b6877abcf82398269f800"; // 例如 Quote Token 地址
  ...
  // 设置最大 Tick 跨度
  console.log("\n正在设置最大 Tick 跨度...");
  const tx = await exchange.setMaxTickCrossedWithinBlock(BASE_TOKEN, MAX_TICK_CROSSED, { gasLimit: 1000000 });
